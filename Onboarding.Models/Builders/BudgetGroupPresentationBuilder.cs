...
namespace Onboarding.Models.Builders
{
    public class BudgetGroupPresentationBuilder
    {
        ...
        //
        public static BudgetGroupPresentation IncomeGroupPresentation
            => new BudgetGroupPresentation(
                ...
                hasDateOnHeader: true);

        public static BudgetGroupPresentation HousingGroupPresentation
            => new BudgetGroupPresentation(iconSource: "icon_housing.png");

        public static BudgetGroupPresentation TransportationGroupPresentation
            => new BudgetGroupPresentation("OnboardingOrange", "icon_auto.png", hasSecondaryHeader: true);
        ...
        public static BudgetGroupPresentation Build(BudgetGroup group)
        {
            ...
            else if (group.Name == budget.HousingGroup.Name)
            {
                return HousingGroupPresentation;
            }
            else if (group.Name == budget.TransportationGroup.Name)
            {
                return TransportationGroupPresentation;
            }
            else if (group.Name == budget.FoodGroup.Name)
            {
                return FoodGroupPresentation;
            }
            else if (group.Name == budget.PersonalGroup.Name)
            {
                return PersonalGroupPresentation;
            }
            else if (group.Name == budget.DebtGroup.Name)
            {
                return DebtGroupPresentation;
            }
            else if (group.Name == budget.GivingGroup.Name)
            {
                return GivingGroupPresentation;
            }
            else if (group.Name == budget.BasicExpensesDisplayGroup.Name)
            {
